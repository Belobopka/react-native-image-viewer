...
var ImageViewer = /** @class */ (function (_super) {
    ...
    function ImageViewer() {
        ...
        _this.goNext = function () {
            if (_this.state.currentShowIndex === _this.props.imageUrls.length - 1) {
                // 回到之前的位置
                _this.resetPosition.call(_this);
                if (typeof _this.props.onArrayEnd === 'function') {
                    _this.props.onArrayEnd();
                }
                return;
            }
            _this.positionXNumber = !react_native_1.I18nManager.isRTL
    ...
    ImageViewer.prototype.getContent = function () {
        ...
        var ImageElements = this.props.imageUrls.map(function (image, index) {
          ...
          {children}
            ...
            switch (imageInfo.status) {
                case 'loading':
                    return (<Wrapper key={index} style={__assign(__assign({}, _this.styles.modalContainer), _this.styles.loadingContainer)} imageWidth={screenWidth} imageHeight={screenHeight}>
              <react_native_1.View style={_this.styles.loadingContainer}>{_this.props.loadingRender()}</react_native_1.View>
                ...
                case 'success':
                    ...
                    image.props.style = __assign(__assign(__assign({}, _this.styles.imageStyle), image.props.style), { width: width,
                        height: height });
        ...
        <react_native_1.Animated.View style={__assign(__assign({}, this.styles.container), { opacity: this.fadeAnim })}>
          ...
          <react_native_1.Animated.View style={__assign(__assign({}, this.styles.moveBox), { transform: [{ translateX: this.positionX }], width: this.width * this.props.imageUrls.length })}>
            {ImageElements}
